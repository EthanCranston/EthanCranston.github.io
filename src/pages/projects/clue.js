...
const Clue = () => {
    return (
        ...
        <p>This project was completed as part of a Software Engineering course, which focused 
            on <a href="https://www.geeksforgeeks.org/solid-principle-in-programming-understand-with-real-life-examples/" target="_blank">
        ...
        <p>On the player's turn, all of their possible moves are highlighted in pink as shown above. When the player moves,
            their piece is animated and moves across the board to its new position. The game also supports hidden passageways
