...
const CustomerManagement = () => {
  return (
        <>
          ...
          <p>The software can read any set of security standards such as the NIST Cyber Security Framework,
             or custom requirements. The software can even handle multiple different standards and automatically
          ...
          <p>The client&apos;s compliance can be assessed interactively with the window shown above. In addition
            to scoring, the GUI allows the user to attach associated files to a question and add notes.
