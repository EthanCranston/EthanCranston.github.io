...
const EquationFinder = () => {
    return (
        ...
        <br></br>
        <p>View the full project here: <a
        href="https://github.com/ecranston405/EquationFinder"><p>https://github.com/ecranston405/EquationFinderddddddddddddddddddddd</p></a></p>
        </>
    );
};
