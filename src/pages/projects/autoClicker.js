...
const AutoClicker = () => {
    return (
        ...
        <p>When looking for an auto clicker, most of the options I found online were either lack the
            functionality I wanted, came from suspicious websites, or were not free. To solve this, I wrote own program.</p>
        <br></br>
        <p>The user interface uses cards to display each instruction. The instructions can be reordered, edited, or deleted
        ...
        <p>My program features a modular design that allows for addition of different functionality. A simple "instruction" class
        ...
        <p>
            View the whole project here: <a href="https://github.com/ecranston405/AutoClicker" target="_blank">https://github.com/ecranston405/AutoClicker</a>
        </p>
